...
1. **시스템 설정 → 개인정보 보호 및 보안 → 손쉬운 사용**에서 Hammerspoon을 켭니다. 키 입력을 받으려면 이 권한이 필요해요.
2. 메뉴바의 Hammerspoon 아이콘 → **Preferences** → **Launch Hammerspoon at login**을 체크합니다. 맥을 다시 켜도 계속 작동해요.
